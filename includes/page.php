        ...
        <div class="container">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/projet_bts-sio_millenuits.png" class="d-block w-50" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h5>Mille-Nuits</h5>
                <p>Projet application web pour une entreprise</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="assets/img/LogoSIO-fb.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
